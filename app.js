...
*/
const cmainRoute = require('./routes/cmain');
...
* */
app.use('/', cmainRoute); // mainRoute is declared to point to routes/main.js
// This route maps the root URL to any path defined in main.js
app.use('/cuser', cuserRoute); // mainRoute is declared to point to routes/main.js

app.use('/feedback',cfeedbackRoute);
...
const vidjotDB = require('./config/cDBConnection');
